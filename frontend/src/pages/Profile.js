      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-9 bg-gray-50">
          {loading ? (
            ...
            <AlertMessage message={error.detail} color="failure" />
          ) : (
                ...
                <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6 ">
                  <div className="grid max-w-screen-md gap-8 mx-auto text-gray-900 ">
                    <div className="flex flex-col items-center justify-center">
                      <dt className="mb-2 text-3xl md:text-5xl font-extrabold text-cyan-700">
                        9
                      </dt>
                      <dd className="font-light text-black text-xl">
                        Total Orders
                      </dd>
                    </div>
                  </div>
