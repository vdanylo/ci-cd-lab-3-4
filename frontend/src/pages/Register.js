...
function Register() {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    dispatch(
      registerAction(email, username, firstName, lastName, password, password2),
    );
  };
        ...
        <div className="mx-auto max-w-screen-sm text-center">
          <div className="w-full bg-gray-100 rounded-lg shadow xl:p-0 p-5">
            <div className=" md:space-y-6 sm:p-8">
              <h2 className="mb-4 text-4xl tracking-tight font-extrabold leading-tight text-cyan-700 dark:text-white mb-5">
                Register
              ...
              <form onSubmit={submitHandler} className="space-y-4 md:space-y-6">
                ...
                <button
                  type="submit"
                  className="w-2/4 text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                >
                  Register
                </button>
