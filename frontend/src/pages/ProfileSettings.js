...
function ProfileSettings() {
  ...
  const updateDetails = useSelector(
    (state) => state.profileUpdateDetailsReducer,
  );
          ...
          <section className="bg-white dark:bg-gray-900">
            <div className="">
              ...
              <form onSubmit={handleSubmit} className="mt-5">
                ...
                <button
                  type="submit"
                  className="float-right inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-orange-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800"
                >
                  Update
                </button>
              </form>
