...
const cartItemsFromStorage = localStorage.getItem("cartItemsStorage")
  ? JSON.parse(localStorage.getItem("cartItemsStorage"))
  : [];

const userInfoFromStorage = localStorage.getItem("userInfoStorage")
  ? JSON.parse(localStorage.getItem("userInfoStorage"))
  : null;

const cartShippingData = localStorage.getItem("shippingData")
